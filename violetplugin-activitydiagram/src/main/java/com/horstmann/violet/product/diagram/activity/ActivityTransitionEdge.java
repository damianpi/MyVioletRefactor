...
public class ActivityTransitionEdge extends SegmentedLineEdge
{
    ...
    public Direction getDirection(INode node)
    {
        ...
        if (SynchronizationBarNode.class.isInstance(getStart()) || SynchronizationBarNode.class.isInstance(getEnd()) || SynchronizationBarVerticalNode.class.isInstance(getStart()) || SynchronizationBarVerticalNode.class.isInstance(getEnd())) {
        	if (node.equals(getStart())) {
