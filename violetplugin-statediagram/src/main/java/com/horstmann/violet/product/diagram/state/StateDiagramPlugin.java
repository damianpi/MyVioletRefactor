...
public class StateDiagramPlugin implements IDiagramPlugin, Violet016FileFilterExtensionPoint
{
    ...
    public Map<String, String> getMappingToKeepViolet016Compatibility()
    {
        ...
        replaceMap.put("com.horstmann.violet.HistoryNode", ShallowHistoryNode.class.getName());
        replaceMap.put("com.horstmann.violet.HistoryNode", DeepHistoryNode.class.getName());
