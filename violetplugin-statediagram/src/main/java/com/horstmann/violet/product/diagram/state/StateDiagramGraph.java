...
public class StateDiagramGraph extends AbstractGraph
{
    ...
    static
    {
        ...
        shallowHistoryNode.setToolTip(rs.getString("node4.tooltip"));
        NODE_PROTOTYPES.add(shallowHistoryNode);
        
        DeepHistoryNode deepHistoryNode = new DeepHistoryNode();
        deepHistoryNode.setToolTip(rs.getString("node5.tooltip"));
        NODE_PROTOTYPES.add(deepHistoryNode);
