...
public class FileCompatiliblyServiceToDelete
{
    ...
    public static InputStream convertFromViolet016(InputStream in)
    {
        ...
        replaceMap.put("com.horstmann.violet.EnumNode", EnumNode.class.getName());
        replaceMap.put("com.horstmann.violet.BallNode", BallNode.class.getName());
        replaceMap.put("com.horstmann.violet.SocketNode", SocketNode.class.getName());
    ...
    public static OutputStream convertToViolet016(OutputStream out)
    {
        ...
        replaceMap.put(EnumNode.class.getName(), "com.horstmann.violet.EnumNode");
        replaceMap.put(BallNode.class.getName(), "com.horstmann.violet.BallNode");
        replaceMap.put(SocketNode.class.getName(), "com.horstmann.violet.SocketNode");
        replaceMap.put(NoteNode.class.getName(), "com.horstmann.violet.NoteNode");
