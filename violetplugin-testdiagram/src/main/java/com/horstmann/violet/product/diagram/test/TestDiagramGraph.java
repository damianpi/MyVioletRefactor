 ...
 */
public class TestDiagramGraph extends AbstractGraph
{
    ...
    static
    {
        ResourceBundle rs = ResourceBundle.getBundle(TestDiagramConstant.TEST_DIAGRAM_STRINGS, Locale.getDefault());
